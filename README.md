# terraform-azurerm-azure-environment-infrastructure

This module deploys the Azure infrastructure required for an Aurora Environment.
...
| <a name="module_cluster"></a> [cluster](#module\_cluster) | git::https://github.com/gccloudone-aurora-iac/terraform-azure-kubernetes-cluster.git | v2.0.7 |
...
| <a name="module_node_pool"></a> [node\_pool](#module\_node\_pool) | git::https://github.com/gccloudone-aurora-iac/terraform-azure-kubernetes-cluster-nodepool.git | v2.0.2 |
...
| 2026-05-22 | v2.0.10 | Upgrade cluster module to v2.0.8 to fix `custom_ca` variable default.                                   |
